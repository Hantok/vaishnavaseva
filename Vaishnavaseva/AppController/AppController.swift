...
@UIApplicationMain
class AppController: UIResponder, UIApplicationDelegate, UINavigationControllerDelegate {

  static var sharedAppController: AppController!
  var isLoggedIn = false
  var window: UIWindow?
  var previousStates: [AppControllerState] = []
  ...
  func navigationController(navigationController: UINavigationController, willShowViewController viewController: UIViewController, animated: Bool)
    {
    (currentState as UINavigationControllerDelegate).navigationController?(navigationController, willShowViewController: viewController, animated: animated)
    }
  
  func navigationController(navigationController: UINavigationController, didShowViewController viewController: UIViewController, animated: Bool)
    {
    (currentState as UINavigationControllerDelegate).navigationController?(navigationController, didShowViewController: viewController, animated: animated)
    }
